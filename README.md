...
2. Create a DB, schemas and tables in your DBMS using query in [this file](https://github.com/denys-domashevskyi/taxi-service/blob/main/src/main/resources/init_db.sql).
3. Configure connection to DB in ConnectionUtil class ([this fields](https://github.com/denys-domashevskyi/taxi-service/blob/main/src/main/java/taxi/util/ConnectionUtil.java#L9)) with your own URL, username, password and JDBC driver.
4. Configure Tomcat (recommended [9.0.50 version](https://archive.apache.org/dist/tomcat/tomcat-9/v9.0.50/bin/)).
